...
def generateSlopeStructure(matrix, height_map, h_max, x_min, x_max, z_min, z_max):
    ...
    if generateRollerCoaster(matrix, height_map, h_max, x_min, x_max, z_min, z_max) == 0:
        return 0
...
def generateRollerCoaster(matrix, height_map, h_max, x_min, x_max, z_min, z_max):
...
def getOrientationFromBinaryIndex(binary_orientation_index):
    rail_orientation = Orientation.HORIZONTAL.value
    default_orientation = Orientation.NORTH_EAST.value

    if binary_orientation_index == 0:
        rail_orientation = Orientation.HORIZONTAL.value
    elif binary_orientation_index == 1:
        rail_orientation = Orientation.HORIZONTAL.value
    elif binary_orientation_index == 2:
        rail_orientation = Orientation.VERTICAL.value
    elif binary_orientation_index == 3:
        rail_orientation = Orientation.NORTH_EAST.value
    elif binary_orientation_index == 4:
        rail_orientation = Orientation.HORIZONTAL.value
    elif binary_orientation_index == 5:
        rail_orientation = Orientation.HORIZONTAL.value
    elif binary_orientation_index == 6:
        rail_orientation = Orientation.SOUTH_EAST.value
    elif binary_orientation_index == 7: # 3 rails
        rail_orientation = Orientation.HORIZONTAL.value
    elif binary_orientation_index == 8:
        rail_orientation = Orientation.VERTICAL.value
    elif binary_orientation_index == 9:
        rail_orientation = Orientation.NORTH_WEST.value
    elif binary_orientation_index == 10:
        rail_orientation = Orientation.VERTICAL.value
    elif binary_orientation_index == 11: # 3 rails
        rail_orientation = Orientation.VERTICAL.value
    elif binary_orientation_index == 12:
        rail_orientation = Orientation.SOUTH_WEST.value
    elif binary_orientation_index == 13: # 3 rails
        rail_orientation = Orientation.HORIZONTAL.value
    elif binary_orientation_index == 14: # 3 rails
        rail_orientation = Orientation.VERTICAL.value
    elif binary_orientation_index == 15: # 4 rails
        rail_orientation = default_orientation
    elif binary_orientation_index == 16:
        rail_orientation = Orientation.NORTH.value
    elif binary_orientation_index == 17:
        rail_orientation = Orientation.EAST.value
    elif binary_orientation_index == 18:
        rail_orientation = Orientation.SOUTH.value
    elif binary_orientation_index == 19:
        rail_orientation = Orientation.WEST.value

    return rail_orientation - 1
...
def choseRandomDirection(matrix, height_map, rail_map, rail_length, current_height_rail_length, max_height_rail_length, x_min, x_max, z_min, z_max, x, z, generatorIndex, previous_x, previous_z):
    ...
    if generatorIndex == 0:
        ...
        if (isNeighbourTheEnd(height_map, rail_map, x, z, x_min, x_max, z_min, z_max, previous_x, previous_z)):
            return_value = 3
    return return_value
...
def isNeighbourTheEnd(height_map, rail_map, x, z, x_min, x_max, z_min, z_max, previous_x, previous_z):
    return ((isInBounds(x + 1, z, x_min, x_max, z_min, z_max) and rail_map[x + 1][z] == 4)
            or (isInBounds(x - 1, z, x_min, x_max, z_min, z_max) and rail_map[x - 1][z] == 4)
            or (isInBounds(x, z + 1, x_min, x_max, z_min, z_max) and rail_map[x][z + 1] == 4)
            or (isInBounds(x, z - 1, x_min, x_max, z_min, z_max) and rail_map[x][z - 1] == 4))
